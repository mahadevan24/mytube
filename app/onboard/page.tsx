...
export default function OnboardPage() {
    ...
    return (
        <div className="min-h-screen bg-neutral-950 text-white flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-2xl text-center">
                ...
                <p className="mt-2 text-base text-neutral-400 max-w-md mx-auto">
                    Set up your multi-user account to enjoy your personal YouTube dashboard without algorithms or clutter.
                </p>
            </div>

            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-2xl">
                <div className="bg-neutral-900/80 backdrop-blur-xl py-8 px-6 sm:px-10 shadow-2xl rounded-2xl border border-white/10 space-y-6">
                    
                    {/* Setup Information Banner */}
                    <div className="bg-neutral-800/60 border border-white/10 rounded-xl p-4 sm:p-5">
                        <div className="flex items-start gap-3">
                            <ShieldCheck className="w-6 h-6 text-emerald-500 shrink-0 mt-0.5" />
                            <div className="text-sm">
                                <h3 className="font-semibold text-white">Why set up a personal account?</h3>
                    ...
                    <form action={clientAction} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="mt-1.5 relative rounded-md shadow-sm">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-10 px-3 py-2.5 bg-neutral-800/90 border border-neutral-700/80 rounded-lg text-white placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm"
                                />
                            </div>
                        </div>
                        ...
                        <div className="pt-2">
                            <div className="flex items-center justify-between">
                                <label htmlFor="youtubeApiKey" className="block text-sm font-medium text-neutral-300">
                                    YouTube Data API Key <span className="text-neutral-500 font-normal">(Optional)</span>
                                </label>
                                <button
                                    type="button"
                            ...
                            <div className="mt-1.5 relative rounded-md shadow-sm">
                                ...
                                <input
                                    ...
                                    type="text"
                                    placeholder="AIzaSy..."
                                    className="block w-full pl-10 px-3 py-2.5 bg-neutral-800/90 border border-neutral-700/80 rounded-lg text-white placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm font-mono"
                                />
                            </div>
                        ...
                        {showGuide && (
                            <div className="bg-neutral-800/90 border border-neutral-700 rounded-xl p-4 text-xs space-y-3 animate-in fade-in slide-in-from-top-2 duration-200">
                                ...
                                <ol className="list-decimal list-inside space-y-1.5 text-neutral-300">
                                    <li>Go to the <a href="https://console.cloud.google.com/" target="_blank" rel="noopener noreferrer" className="text-emerald-400 underline hover:text-emerald-300">Google Cloud Console</a>.</li>
                                    ...
                                    <li>Copy the generated key (starts with <code className="bg-neutral-900 px-1 py-0.5 rounded">AIza...</code>) and paste it into the field above.</li>
                                </ol>
                    ...
                    <div className="pt-4 border-t border-white/10 text-center text-sm text-neutral-400">
