    ...
    return (
        <div className="min-h-screen bg-neutral-950 text-white flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-neutral-900/80 backdrop-blur-xl py-8 px-6 shadow-2xl rounded-2xl border border-white/10 sm:px-10 space-y-6">
                        ...
                        <div>
                            ...
                            <div className="mt-1.5">
                                <input
                                    ...
                                    className="block w-full px-3 py-2.5 bg-neutral-800/90 border border-neutral-700/80 rounded-lg text-white placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm"
                                />
                            </div>
                        </div>
                    ...
                    <div className="pt-4 border-t border-white/10 text-center text-sm text-neutral-400">
                        New user?{' '}
                        <Link href="/onboard" className="font-semibold text-emerald-400 hover:text-emerald-300 underline underline-offset-4 transition-colors">
